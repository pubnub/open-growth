opengrowth.signals.blocks1 = ( request, customer ) => {
    ...
    const message = 
        `<p>Hi ${name || 'there'},</p>` + 
        `<p>I noticed your PubNub ${request.message.block_name} block in your ${request.message.app_name} app will expire in 3 days. We have a 30 day limit on running blocks in the FREE tier. You can upgrade to a new plan starting out at $49 to keep blocks running continuously.</p>` +
